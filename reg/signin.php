    ...
    <style>
        * {
        ...
        form {
            ...
            text-align: center;
            border-radius: 10px;
            background-image: linear-gradient(270deg, #ff00aa 0%, #86acf4 74%);
            width: 30em;
            height: 20em;
            padding-top: 2.5em;
            border-radius: 60px;
    ...
    <form action='login.php' method='post' class="form.register">
        <div class="contendro-inputs">
            <div class="form">
                ...
                <br> <br>
                <button type="submit" class="btn" name="log_user"> SignIn</button>
                <p class="al">don't have an account?</p>
