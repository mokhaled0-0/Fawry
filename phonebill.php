...
<body>
    ...
    <h1 class="title"><i class="fas fa-phone-alt"></i> PHONE BILL </h1>
    <center>
        <div class="container">
            <form method="post">
                <div class="form">
                    ...
                    <br><br>
                    <button type="submit" class="btn" name="ss"
                        onclick="document.getElementById('visible').style.visibility='visible'">Enter your
                        number</button><br>
                    <button type="button" class="btn" name="sss"
                        onclick="document.getElementById('visible').style.visibility='visible'">Get The Bill</button>
                </div>
            </form>
        </div>
    </center>
        ...
        ><form class="bill">
            ...
            **********************************************
            ...
            <div class="sr">
                ...
                if(isset($_POST['ss'])){
                $search=$_POST['search'];
                $tsql="SELECT code,phone_number,payment_value FROM phone_bills  WHERE phone_number like '%$search%';";
                ...
                ?>
                <h4>-----------------------------------</h4>You Can Pay With This Code In Any Brunch!<br>Or You Can Pay
                Here.<a target="_blank" href="payment.html"> pay now!</a><br>
                <h4>-----------------------------------</h4>When networks are down,<br> this process takes 24 hours.</p>
                **********************************************
            </div>
            <script>
