...
<section class="header">
    ...
    <h1 class="title"><i class="fas fa-hand-holding-water"></i>  WATER BILL </h1>
    ...
    <form class="bill">
        <div></div>
            <p>
                ...
                if(isset($_POST['ss'])){
                $search=$_POST['search'];
                $tsql="SELECT code,phone_number,payment_value FROM water_bills  WHERE phone_number like '%$search%';";
